...
+ (NSRange)bindingPortRange
{
  ...
  if (NSProcessInfo.processInfo.environment[@"WEBDRIVERAGENT_PORT"]) {
    return NSMakeRange([NSProcessInfo.processInfo.environment[@"WEBDRIVERAGENT_PORT"] integerValue] , 1);
  }
